...
import "./MoonPlayToken.sol";

contract MoonPlayTokenPreSale {
    MoonPlayToken public token;
    ...
    function MoonPlayTokenPreSale(
        MoonPlayToken _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MoonPlayToken(_token);
        beneficiary = _beneficiary;
        alfatokenteam = _alfatokenteam;
        bonus = 50;
        price = 0;
        minSaleAmount = 10000000000;
    }
